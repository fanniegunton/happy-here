 ...
 * @param targetDate - The date to use (defaults to current date/time)
 * @returns The end time as a number (e.g., 2000 for 8pm), or null if no range covers the current time.
 */
export const getTodayEndTime = (hoursArray: string[], targetDate: Date = new Date()): number | null => {
