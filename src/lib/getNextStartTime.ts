 ...
 *
 * @param hoursArray - Array of hours strings (e.g. "Mon: 11am–8pm", "Tue–Wed: 8am–4pm")
 * @param targetDate - The reference date/time (defaults to now)
 * @returns A Date object representing the next start time, or null if none is defined.
 */
export const getNextStartTime = (hoursArray: string[], targetDate: Date = new Date()): Date | null => {
  ...
  const currentMilitaryTime = targetDate.getHours() * 100 + targetDate.getMinutes();
